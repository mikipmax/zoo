...
import modelo.Guias;
/**
 * Frame Cuidador_vista que me permite visualizar gráficamente el crud de la clase Cuidadores
 *
 * @author Diego
 * @version 1.0
 */
public class Cuidador_vista extends javax.swing.JInternalFrame {
/**
 * variables globales
 */
    int mod;
    private List<Cuidadores> tareas;
    private static int bandera_encontrado = 0;
    private static int bandera_buscar = 0;
    public static int bandera_cuidador_orden = 0;
    private static int bandera_crear_editar = 0;
/**
 * Constructor del frame
 */
    public Cuidador_vista() {
        initComponents();
...
/**
 * Método que me permite carga en una tabla los datos de los cuidadores
 */
    private void cargar_lista_de_tareas() {
        try {

            this.tareas = Controlador_cuidadores.cargarArbol();
    ...
    private void initComponents() {
        ...
        elemento_tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nombre del cuidador", "Dirección", "Teléfono", "Fecha Ingreso"
            }
        ));
        ...
        jLabel1.setText("Nombre del Cuidador");
    ...
    private void btnbuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnbuscarActionPerformed
        ...
        try {
            ...
            if (!txtbuscar.getText().isEmpty()) {
                bandera_buscar = 1;
                this.tareas = Controlador_cuidadores.recuperarPorId(txtbuscar.getText());
                if (!tareas.isEmpty()) {
        ...
        try {
            if (mod == 1) {
                if (dt_fechaIn.getDate() != null) {
                    Controlador_cuidadores.editar(txtNe.getText(), txtNc.getText(), txtDe.getText(), dt_fechaIn.getDate());
                ...
                if (!txtNe.getText().isEmpty() && dt_fechaIn.getDate() != null) {
                    ...
                    if (ban_repetido == 0) {
                        ...
                        int ban_guias_existe = 0;
                        listaGuias = Controlador_guias.cargarArbol();
                        for (Guias listaG : listaGuias) {
                            if (listaG.getNombre().equalsIgnoreCase(txtNe.getText())) {
                                ban_guias_existe = 1;
                            }
                        }
                        if (ban_guias_existe == 0) {
                            this.guardar();
                            txtNe.setText("");
                            txtNc.setText("");
                            txtDe.setText("");
                            ...
                            JOptionPane.showMessageDialog(null, "El empleado ya existe y es un Guía");
                        }

                    } else {
                        JOptionPane.showMessageDialog(null, "El cuidador ya existe");
                    }

                } else {
                    JOptionPane.showMessageDialog(null, "Ingrese un nombre y una fecha al menos");
                }
            ...
            switch (cb_crud.getSelectedItem().toString()) {
                ...
                case "Editar":
                    ...
                    if (bandera_encontrado == 1 && bandera_buscar == 1) {
                        ...
                        Cuidadores es = this.tareas.get(0);
                ...
                case "Eliminar":
                    if (bandera_encontrado == 1 && bandera_buscar == 1) {
                        ...
                        tareas = Controlador_cuidadores.eliminar(idc);
                        DefaultTableModel dtm = (DefaultTableModel) elemento_tabla.getModel();
                        dtm.setRowCount(0);
                        for (int i = 0; i < this.tareas.size(); i++) {
                            String mes = "";
    ...
    private void cb_ordenarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cb_ordenarActionPerformed
        switch (cb_ordenar.getSelectedItem().toString()) {
            ...
            case "nombre Ascendente":
                try {
                    ...
                    if ((bandera_buscar == 0 || bandera_encontrado == 0) && bandera_crear_editar == 0) {
                        ...
                        this.tareas = Controlador_cuidadores.ordenarAsc();
                    }
            ...
            case "nombre Descendente":
                ...
                try {
                    if ((bandera_buscar == 0 || bandera_encontrado == 0) && bandera_crear_editar == 0) {
                        this.tareas = Controlador_cuidadores.ordenarDes();
                    }
                } catch (Exception ex) {
                    System.out.println(ex.getMessage());
                    JOptionPane.showMessageDialog(this, "Ha surgido un error y no se han podido recuperar los registros");
            ...
            case "dirección Ascendente":
                if ((bandera_buscar == 0 || bandera_encontrado == 0) && bandera_crear_editar == 0) {
                    bandera_cuidador_orden = 1;
                    this.tareas = Controlador_cuidadores.ordenarAsc();
                    bandera_cuidador_orden = 0;
                }
                break;
    ...
    /**
     * Método que me permite guardar los datos de un cuidador a través del controlador
     */
    private void guardar() {
        ...
        Controlador_cuidadores.guardarArbol(nombre, direccion, telefono, fechaIn);
        System.out.println("");
        cargar_lista_de_tareas();
    }
