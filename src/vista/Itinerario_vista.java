...
import controlador.Controlador_itinerarios;

/**
 * Frame Itinerario_vista que me permite visualizar gráficamente el crud de la clase Itinerarios
 *
 * @author Diego
 * @version 1.0
 */
public class Itinerario_vista extends javax.swing.JInternalFrame {
/**
 * Variables globales
 */
    int mod;
    private List<Itinerarios> tareas;
    private static int bandera_encontrado = 0;
    private static int bandera_buscar = 0;
    public static int bandera_itin_orden = 0;
    private static int bandera_crear_editar = 0;
/**
 * Constructor del Frame
 */
    public Itinerario_vista() {
        initComponents();
...
/**
 * Método que me permite cargar en una tabla los datos de los itinerarios
 */
    private void cargar_lista_de_tareas() {
        try {
            this.tareas = Controlador_itinerarios.cargarArbol();
            DefaultTableModel dtm = (DefaultTableModel) elemento_tabla.getModel();
            dtm.setRowCount(0);
            for (int i = 0; i < this.tareas.size(); i++) {
                dtm.addRow(new Object[]{
                    this.tareas.get(i).getCodItiner(),
                    this.tareas.get(i).getDuracionRec(),
                    this.tareas.get(i).getLongItiner(),
                    this.tareas.get(i).getNumMaxVisit(),
                    this.tareas.get(i).getNumDistEsp()
    ...
    private void initComponents() {
        ...
        elemento_tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cod Itinerario", "Duración rec", "Long Itinerario", "Num max visita", "Num dist especies"
            }
        ));
        ...
        jLabel1.setText("Cod Itinerario");

        jLabel2.setText("Duración rec");

        jLabel4.setText("Long Itinerario");
        ...
        jLabel8.setText("Num Max Visitas");

        jLabel9.setText("Num dist especies");
        ...
        jLabel3.setText("Código de Itinerario:");

        cb_ordenar.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Código Itinerario Ascendente", "Código Itinerario Descendente", "Duración rec Ascendente", "Duración rec Descendente" }));
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(cb_ordenar, 0, 290, Short.MAX_VALUE)))
    ...
    private void btnbuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnbuscarActionPerformed
        ...
        try {
            ...
            if (!txtbuscar.getText().isEmpty()) {
                bandera_buscar = 1;
                this.tareas = Controlador_itinerarios.recuperarPorId(Integer.valueOf(txtbuscar.getText()));
                if (!tareas.isEmpty()) {
    ...
    private void elemento_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_elemento_guardarActionPerformed
        try {
            if (mod == 1) {
                ...
                Controlador_itinerarios.editar(Integer.valueOf(txtNe.getText()), Integer.valueOf(txtNc.getText()), Integer.valueOf(txtDe.getText()), Integer.valueOf(txtNm.getText()), Integer.valueOf(txtNd.getText()));
                ...
                if (!txtNe.getText().isEmpty()) {
                    ...
                    int ban_repetido = 0;
                    this.tareas = Controlador_itinerarios.cargarArbol();
                    for (Itinerarios tarea : tareas) {

                        if (Integer.valueOf(txtNe.getText()) == tarea.getCodItiner()) {
        ...
        JOptionPane.showMessageDialog(null, "campo(s) vacios/solo se acepta números");
        }
            ...
            switch (cb_crud.getSelectedItem().toString()) {
                ...
                case "Editar":
                    ...
                    if (bandera_encontrado == 1 && bandera_buscar == 1) {
                        ...
                        Itinerarios es = this.tareas.get(0);

                        txtNe.setText(String.valueOf(es.getCodItiner()));
                        txtNc.setText(String.valueOf(es.getDuracionRec()));
                        txtDe.setText(String.valueOf(es.getLongItiner()));
                        txtNm.setText(String.valueOf(es.getNumMaxVisit()));
                        txtNd.setText(String.valueOf(es.getNumDistEsp()));
                        mod = 1;
                        bandera_buscar = 0;
                        bandera_crear_editar = 1;
                    }
                ...
                case "Eliminar":
                    if (bandera_encontrado == 1 && bandera_buscar == 1) {
                        ...
                        int idc = (int) elemento_tabla.getValueAt(0, 0);

                        tareas = Controlador_itinerarios.eliminar(idc);
                        DefaultTableModel dtm = (DefaultTableModel) elemento_tabla.getModel();
                        dtm.setRowCount(0);
                        for (int i = 0; i < this.tareas.size(); i++) {
                            dtm.addRow(new Object[]{
    ...
    private void cb_ordenarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cb_ordenarActionPerformed
        switch (cb_ordenar.getSelectedItem().toString()) {
            ...
            case "Código Itinerario Ascendente":
                try {
                    ...
                    if ((bandera_buscar == 0 || bandera_encontrado == 0) && bandera_crear_editar == 0) {
                        ...
                        this.tareas = Controlador_itinerarios.ordenarAsc();
                    }
                ...
                break;
            case "Código Itinerario Descendente":

                try {
                    if ((bandera_buscar == 0 || bandera_encontrado == 0) && bandera_crear_editar == 0) {
                        this.tareas = Controlador_itinerarios.ordenarDes();
                    }
                } catch (Exception ex) {
                    System.out.println(ex.getMessage());
                    JOptionPane.showMessageDialog(this, "Ha surgido un error y no se han podido recuperar los registros");
                ...
                break;
            case "Duración rec Ascendente":
                if ((bandera_buscar == 0 || bandera_encontrado == 0) && bandera_crear_editar == 0) {
                    bandera_itin_orden = 1;
                    this.tareas = Controlador_itinerarios.ordenarAsc();
                    bandera_itin_orden = 0;
                }
                break;
            case "Duración rec Descendente":
                if ((bandera_buscar == 0 || bandera_encontrado == 0) && bandera_crear_editar == 0) {
                    bandera_itin_orden = 1;
                    this.tareas = Controlador_itinerarios.ordenarDes();
                    bandera_itin_orden = 0;
  ...
  /**
   * Método que me permite guardar los datos de un itinerario a través del controlador
   */
    private void guardar() {
        int codIt = Integer.valueOf(txtNe.getText());
        int duracionRec = Integer.valueOf(txtNc.getText());
        int longRec = Integer.valueOf(txtDe.getText());
        int numMax = Integer.valueOf(txtNm.getText());
        int numDist = Integer.valueOf(txtNd.getText());

        Controlador_itinerarios.guardarArbol(codIt, duracionRec, longRec, numMax, numDist);
        System.out.println("");
        cargar_lista_de_tareas();
    }
