...
import modelo.Zonas;
import controlador.Controlador_zonas;

/**
 * Frame Zonas_vista que me permite visualizar gráficamente el crud de la clase Zonas
 *
 * @author Diego
 * @version 1.0
 */
public class Zonas_vista extends javax.swing.JInternalFrame {
/**
 * Variables globales
 */
    int mod;
    private List<Zonas> tareas;
    private static int bandera_encontrado = 0;
    private static int bandera_buscar = 0;
    public static int bandera_zonas_orden = 0;
...
/**
 * Mëtodo que me permite cargar en una tabla los datos de las zonas
 */
    private void cargar_lista_de_tareas() {
        try {
            this.tareas = Controlador_zonas.cargarArbol();
            DefaultTableModel dtm = (DefaultTableModel) elemento_tabla.getModel();
            dtm.setRowCount(0);
            for (int i = 0; i < this.tareas.size(); i++) {
                dtm.addRow(new Object[]{
                    this.tareas.get(i).getNombreZon(),
                    this.tareas.get(i).getExt()
    ...
    private void initComponents() {
        ...
        cb_ordenar.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "nombre Ascendente", "nombre Descendente", "extensión Ascendente", "extensión Descendente" }));
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(cb_ordenar, 0, 237, Short.MAX_VALUE))
                        .addGap(18, 18, 18))
    ...
    private void btnbuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnbuscarActionPerformed
        ...
        try {
            ...
            if (!txtbuscar.getText().isEmpty()) {
                bandera_buscar = 1;
                this.tareas = Controlador_zonas.recuperarPorId(txtbuscar.getText());
                if (!tareas.isEmpty()) {
    ...
    private void elemento_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_elemento_guardarActionPerformed
        ...
        if (mod == 1) {
            ...
            Controlador_zonas.editar(txtNe.getText(), txtNc.getText());
            ...
            if (!txtNe.getText().isEmpty()) {
                ...
                int ban_repetido = 0;
                this.tareas = Controlador_zonas.cargarArbol();
                for (Zonas tarea : tareas) {

                    if (txtNe.getText().equalsIgnoreCase(tarea.getNombreZon())) {
                ...
                if (ban_repetido == 0) {
                    ...
                    JOptionPane.showMessageDialog(null, "La Zona ya existe");
                }
            ...
            switch (cb_crud.getSelectedItem().toString()) {
                ...
                case "Editar":
                    ...
                    if (bandera_encontrado == 1 && bandera_buscar == 1) {
                        ...
                        Zonas es = this.tareas.get(0);

                        txtNe.setText(es.getNombreZon());
                        txtNc.setText(es.getExt());
                ...
                case "Eliminar":
                    if (bandera_encontrado == 1 && bandera_buscar == 1) {
                        ...
                        tareas = Controlador_zonas.eliminar(idc);
                        DefaultTableModel dtm = (DefaultTableModel) elemento_tabla.getModel();
                        dtm.setRowCount(0);
                        for (int i = 0; i < this.tareas.size(); i++) {
                            dtm.addRow(new Object[]{
    ...
    private void cb_ordenarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cb_ordenarActionPerformed
        switch (cb_ordenar.getSelectedItem().toString()) {
            case "nombre Ascendente":
                try {
                    ...
                    if ((bandera_buscar == 0 || bandera_encontrado == 0) && bandera_crear_editar == 0) {
                        ...
                        this.tareas = Controlador_zonas.ordenarAsc();
                    }
            ...
            case "nombre Descendente":
                ...
                try {
                    if ((bandera_buscar == 0 || bandera_encontrado == 0) && bandera_crear_editar == 0) {
                        this.tareas = Controlador_zonas.ordenarDes();
                    }
                } catch (Exception ex) {
                    System.out.println(ex.getMessage());
                    JOptionPane.showMessageDialog(this, "Ha surgido un error y no se han podido recuperar los registros");
                ...
                break;
            case "extensión Ascendente":
                if ((bandera_buscar == 0 || bandera_encontrado == 0) && bandera_crear_editar == 0) {
                    bandera_zonas_orden = 1;
                    this.tareas = Controlador_zonas.ordenarAsc();
                    bandera_zonas_orden = 0;
                }
                break;
            case "extensión Descendente":
                if ((bandera_buscar == 0 || bandera_encontrado == 0) && bandera_crear_editar == 0) {
                    bandera_zonas_orden = 1;
                    this.tareas = Controlador_zonas.ordenarDes();
                    bandera_zonas_orden = 0;
   ...
   /**
    * Método que me permite guardar los datos de una zona a través del controlador
    */
    private void guardar() {
        String nombre = txtNe.getText();
        String ext = txtNc.getText();

        Controlador_zonas.guardarArbol(nombre, ext);
        System.out.println("");
        cargar_lista_de_tareas();
    }
